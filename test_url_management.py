...
# Configuration
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://support-portal-69.preview.emergentagent.com')
    ...
    def test_get_student_portal_url_logic(self):
        ...
        test_cases = [
            ...
            },
            {
                ...
                "expected": "https://support-portal-69.preview.emergentagent.com"
            }
        ]
